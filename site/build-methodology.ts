...
review, and six candidate events were rejected before entry. The defects were in the metadata
around them. That correction is in progress and this page will state when it lands.</p>
...
<h2>What the sentinel depends on, and how it fails</h2>
